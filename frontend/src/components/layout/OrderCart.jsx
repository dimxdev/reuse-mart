...
import useEditOrderStatus from "../../api/useEditOrderStatus";

function OrderCard({ order }) {
  const { handleEditOrderStatus } = useEditOrderStatus();
  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
      ...
      <div className="mb-4 pb-4 border-b">
        <h4 className="font-semibold text-gray-800 mb-2">Informasi Penerima</h4>
      ...
      {/* Daftar Barang */}
      <div className="mb-4 pb-4 border-b">
        <h4 className="font-semibold text-gray-800 mb-3">Barang yang Dibeli</h4>
