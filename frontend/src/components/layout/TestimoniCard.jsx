function TestimoniCard(props) {
  ...
  return (
    <div className="py-10 bg-tema-100 shadow-md w-full rounded-md flex flex-col justify-center items-center gap-4 group hover:scale-105 hover:shadow-xl transition-all duration-400">
