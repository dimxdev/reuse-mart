function Features(props) {
  ...
  return (
    <div className="py-10 bg-tema-100 shadow-md w-full rounded-md flex flex-col justify-center items-center gap-2 group hover:scale-105 hover:shadow-xl transition-all cursor-pointer duration-300">
