        ...
        <section className="text-center py-20 px-8">
          ...
          >
            {teamMembers.map((member, index) => (
              <motion.div
                key={index}
                className={`cursor-pointer bg-white py-8 rounded-xl shadow-2xl transition duration-300 hover:shadow-tema-400/50 lg:col-span-2 ${
                  teamMembers.length === 5 && index === 3 ? "lg:col-start-2" : ""
                }`}
                variants={{
