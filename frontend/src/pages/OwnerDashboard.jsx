...
const statsData = {
  ...
  revenueGrowth: 15.3,
  totalOrders: 2,
  ordersStatus: "Semua pesanan",
  averageOrder: 1975000,
  activeUsers: 247,
  usersStatus: "Pengguna terdaftar",
};
  ...
  return (
    <div className="min-h-screen pt-25 p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-2">
            Rp {formatRupiah(statsData.totalRevenue)}
          </h3>
          <p className="text-tema-600 text-sm">
            +{statsData.revenueGrowth}% dari bulan lalu
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          ...
          <p className="text-gray-500 text-sm">{statsData.ordersStatus}</p>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-2">
            Rp {formatRupiah(statsData.averageOrder)}
          </h3>
          <p className="text-gray-500 text-sm">Per transaksi</p>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          ...
          <p className="text-gray-500 text-sm">{statsData.usersStatus}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm mb-8">
        ...
        <div className="space-y-2">
          {adminUsers.map((admin, index) => (
            ...
            >
              ...
              <button className="p-2 bg-white cursor-pointer hover:bg-red-100 rounded-lg transition-colors group">
                <svg
        ...
        {showAddAdminForm && <AddAdminForm onClose={onClose}/>}
      </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <button className="px-6 py-3 bg-tema-500 text-white rounded-lg font-medium hover:bg-tema-600 transition-colors">
          Export Report
        </button>
      </div>
    </div>
